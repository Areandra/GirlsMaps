...
const LandingPage = React.memo(
  ({ lastPage, navRef, windowSize, user, setLastPage, dissmis }) => {
    ...
    const featureCardList = [
      {
        id: "locationStore",
        text: "Direktori Toko Kosmetik",
        imageUrl: service1,
      },
      {
        id: "searchProduct",
        text: "Pencarian Merek & Produk",
        imageUrl: service2,
      },
    ];
        ...
        >
            ...
            >
              <div style={LandingPageStyles.sloganGroup}>
                ...
                >
                  ...
                  Kompas Terbaik untuk Kecantikanmu
                </h3>
              </div>
              <h1
                style={{
              ...
              >
                Kamu Tahu Produknya, Kami Tahu Tokonya. Kita Petakan{" "}
                <GradientText
                  style={{
                    fontSize: windowSize.width > 800 ? "2.75rem" : "1.5rem",
                  }}
              ...
              >
                Jadikan peta interaktif kami sebagai pemandumu. Cari produk dan
                merek favorit, lalu temukan setiap toko lokal yang
                menyediakannya. Kami berikan lokasinya, kamu yang tentukan
                pilihanmu. Semudah itu.
              </p>
            </div>
          ...
          {windowSize.height > 575 && (
            <div style={LandingPageStyles.cardGroup}>
              <AutoSlideCard cardContentList={featureCardList} />
            </div>
          )}
        </div>
      </>
